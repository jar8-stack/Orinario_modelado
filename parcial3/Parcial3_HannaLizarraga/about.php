        ...
        <div class="row">
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  ...
                  <h3 class="block-38-heading h4">Hanna Siddharttha</h3>
                  <p class="block-38-subheading">CEO/Co-Founder</p>
                </div>
                <div class="block-38-body">
                  <p>Software Enginering and cat lover</p>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="images/person_2.jpeg" alt="Image placeholder" class="mb-4">
                  <h3 class="block-38-heading h4">Hanna Romero</h3>
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  ...
                  <h3 class="block-38-heading h4">Christian Cabral</h3>
                  <p class="block-38-subheading">Director</p>
                </div>
                <div class="block-38-body">
                  <p>Software Enginering and addicted to lasagna and video games</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  ...
                  <h3 class="block-38-heading h4">Jade Bañuelos</h3>
                  <p class="block-38-subheading">Sales Manager</p>
                </div>
                <div class="block-38-body">
                  <p>Software Enginering and designer </p>
                </div>
              </div>
            </div>
          </div>
