...
<body>
              ...
              <table class="table table-bordered">
                <thead>
                  <tr>
                    ...
                    <th class="product-name">Destiny</th>
                    <th class="product-price">Price</th>
                    <th class="product-quantity">Passengers</th>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="input-group mb-3" style="max-width: 120px;">
                            ...
                            <input type="text" class="form-control text-center txtCantidad" value="<?php echo $arregloCarrito[$i]['Cantidad']; ?>" data-precio="<?php echo $arregloCarrito[$i]['Precio']; ?>" data-id="<?php echo $arregloCarrito[$i]['id']; ?>" value="<?php echo $arregloCarrito[$i]['Cantidad']; ?>" placeholder="" aria_label="Example text with button addon" aria-describedby="button-addon1">
                        ...
                        <td class="cant<?= $arregloCarrito[$i]['id'] ?>">
          ...
          <div class="col-md-6">
            <div class="row mb-5">
              <div class="col-md-6 mb-3 mb-md-0">
                <a class="btn btn-primary btn-sm btn-block" href="index.php" >Regresar</a>
              </div>
              <div class="col-md-6">
                <a class="btn btn-outline-primary btn-sm btn-block" href="compra.php" >Continue Shopping</a>
              </div>
            </div>
          </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      $(".btnIncrementar, .js-btn-minus").click(function() {
